  ...
  return (
    <>
        ...
        <>
          <div className="home-container">
            ...
            <div className="hero-section">
              ...
              <p>
                Empower your learning with AI-driven viva practice.
                Automatically generated questions, anti-cheat protections, and
                real-time evaluation to boost your confidence!
              </p>
            </div>
            ...
            <div className="how-it-works">
              ...
              <ol>
                <li>
                  Join <strong>Viva</strong> and <strong>Take Test</strong>
                </li>
            ...
            <div className="testimonials">
              ...
              <div className="testimonial-card">
                <p>
                  "This app helped me prepare for my practicals quickly and
                  effectively. The best part is the anti-cheat features that
                  make it feel like a real exam!" –{" "}
                  <strong>Sarbaz Malek, MCA Student</strong>
                </p>
              </div>
              <div className="testimonial-card">
                <p>
                  "As a teacher, I can monitor students' progress and create
                  class-specific viva tests. Brilliant tool!" –{" "}
                  <strong>Prof. CD Patel, AMPICS Dept.</strong>
                </p>
              </div>
            </div>
            ...
            <div className="cta-section">
              ...
              <p>
                Login or register to get started. No more boring preparations!
              </p>
              <Link
                to="/login"
                style={{
      ...
      <div className="wlcm">
        {UserInfo.length > 0 && (
          <center>
            <h3>Welcome {UserInfo[0].payload.name} 👋</h3>
          </center>
        )}
      </div>
      <div className="dashboard-container">
        {UserInfo.length > 0 && (
          ...
          >
            🛠️ {UserInfo[0].payload.role == 0 ? "Student" : "Educator"} Features
          </h1>
        )}
        {UserInfo.length > 0 && (
          <>
